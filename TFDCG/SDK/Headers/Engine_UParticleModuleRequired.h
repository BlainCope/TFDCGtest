...
namespace CG::Engine
{
    ...
    public:
        ...
        bool                                                         bSupportLargeWorldCoordinates : 1;                       //  BIT_FIELD Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        Engine::UTexture2D*                                          CutoutTexture;                                           //  Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
