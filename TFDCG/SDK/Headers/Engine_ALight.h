...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::ULightComponent*                                     LightComponent;                                          //  BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
