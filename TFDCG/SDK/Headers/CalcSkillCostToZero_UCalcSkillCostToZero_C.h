...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Gameplay/Common/Calculation/Special/CalcSkillCostToZero.CalcSkillCostToZero_C
     * Size -> 0x0010 (FullSize[0x0108] - InheritedSize[0x00F8])
     */
    class UCalcSkillCostToZero_C : public CalcEtcBase::UCalcEtcBase_C
    {
    public:
        ...
        double                                                       MinRate;                                                 //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Gameplay/Common/Calculation/Special/CalcSkillCostToZero.CalcSkillCostToZero_C");
            return ptr;
        }
    };
}
