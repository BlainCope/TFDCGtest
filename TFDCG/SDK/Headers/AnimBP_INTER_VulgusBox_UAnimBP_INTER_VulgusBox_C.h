...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Blueprints/InteractionObject/AnimBP_INTER_VulgusBox.AnimBP_INTER_VulgusBox_C
     * Size -> 0x0288 (FullSize[0x05B8] - InheritedSize[0x0330])
     */
    class UAnimBP_INTER_VulgusBox_C : public M1::UM1FieldInteractableActorAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_AnimBP_INTER_VulgusBox(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Blueprints/InteractionObject/AnimBP_INTER_VulgusBox.AnimBP_INTER_VulgusBox_C");
            return ptr;
        }
    };
}
