...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_AddBoneTransform : public ControlRig::FRigUnitMutable
    {
    public:
        ...
        bool                                                         bPostMultiply;                                           //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
