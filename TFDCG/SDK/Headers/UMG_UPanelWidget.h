...
namespace CG::UMG
{
    ...
    {
    public:
        BasicTypes::TArray<UMG::UPanelSlot*>                         Slots;                                                   //  ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected
    ...
    public:
        ...
        BasicTypes::TArray<UMG::UWidget*> GetAllChildren();
        void ClearChildren();
