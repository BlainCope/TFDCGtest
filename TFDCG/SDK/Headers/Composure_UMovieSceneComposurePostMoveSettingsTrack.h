...
namespace CG::Composure
{
     ...
     */
    class UMovieSceneComposurePostMoveSettingsTrack : public MovieSceneTracks::UMovieScenePropertyTrack
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Composure.MovieSceneComposurePostMoveSettingsTrack");
            return ptr;
        }
    };
}
