...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::FSplineCurves                                        SplineCurves;                                            //  Edit, Net, NativeAccessSpecifierPublic
        ...
        int32_t                                                      ReparamStepsPerSegment;                                  //  Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bStationaryEndpoints;                                    //  Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bSplineHasBeenEdited;                                    //  Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bInputSplinePointsToConstructionScript;                  //  Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bClosedLoop;                                             //  Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        bool                                                         bLoopPositionOverride;                                   //  Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        uint8_t                                                      UnknownData_0001[0x1];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        float                                                        LoopPosition;                                            //  Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        CoreUObject::FVector                                         DefaultUpVector;                                         //  Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
    ...
    public:
        ...
        void SetTangentColor(const CoreUObject::FLinearColor& TangentColor);
        ...
        void SetScaleAtSplinePoint(int32_t PointIndex, const CoreUObject::FVector& InScaleVector, bool bUpdateSpline);
        void SetRotationAtSplinePoint(int32_t PointIndex, const CoreUObject::FRotator& InRotation, Engine::ESplineCoordinateSpace CoordinateSpace, bool bUpdateSpline);
        ...
        CoreUObject::FVector GetVectorPropertyAtSplinePoint(int32_t Index, const BasicTypes::FName& PropertyName);
        CoreUObject::FVector GetVectorPropertyAtSplineInputKey(float InKey, const BasicTypes::FName& PropertyName);
        ...
        CoreUObject::FVector GetUpVectorAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        CoreUObject::FTransform GetTransformAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace, bool bUseScale);
        ...
        CoreUObject::FVector GetTangentAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        CoreUObject::FVector GetScaleAtSplineInputKey(float InKey);
        ...
        CoreUObject::FRotator GetRotationAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        float GetRollAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        CoreUObject::FVector GetRightVectorAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        CoreUObject::FVector GetLocationAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        float GetFloatPropertyAtSplinePoint(int32_t Index, const BasicTypes::FName& PropertyName);
        float GetFloatPropertyAtSplineInputKey(float InKey, const BasicTypes::FName& PropertyName);
        ...
        CoreUObject::FVector GetDirectionAtSplineInputKey(float InKey, Engine::ESplineCoordinateSpace CoordinateSpace);
        ...
        bool DivideSplineIntoPolylineRecursiveWithDistances(float StartDistanceAlongSpline, float EndDistanceAlongSpline, Engine::ESplineCoordinateSpace CoordinateSpace, float MaxSquareDistanceFromSpline, BasicTypes::TArray<CoreUObject::FVector>* OutPoints, BasicTypes::TArray<double>* OutDistancesAlongSpline);
        bool DivideSplineIntoPolylineRecursive(float StartDistanceAlongSpline, float EndDistanceAlongSpline, Engine::ESplineCoordinateSpace CoordinateSpace, float MaxSquareDistanceFromSpline, BasicTypes::TArray<CoreUObject::FVector>* OutPoints);
        bool ConvertSplineToPolyLine(Engine::ESplineCoordinateSpace CoordinateSpace, float MaxSquareDistanceFromSpline, BasicTypes::TArray<CoreUObject::FVector>* OutPoints);
        bool ConvertSplineSegmentToPolyLine(int32_t SplinePointStartIndex, Engine::ESplineCoordinateSpace CoordinateSpace, float MaxSquareDistanceFromSpline, BasicTypes::TArray<CoreUObject::FVector>* OutPoints);
