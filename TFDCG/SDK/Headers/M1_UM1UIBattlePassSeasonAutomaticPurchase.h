...
{
    /**
     * Class /Script/M1.M1UIBattlePassSeasonAutomaticPurchase
     * Size -> 0x0008 (FullSize[0x0788] - InheritedSize[0x0780])
     */
    class UM1UIBattlePassSeasonAutomaticPurchase : public M1::UM1UIPopupContent
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIBattlePassSeasonAutomaticPurchase");
            return ptr;
        }
    };
}
