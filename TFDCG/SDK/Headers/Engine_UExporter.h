...
namespace CG::Engine
{
    ...
    {
    public:
        CoreUObject::UObject*                                        SupportedClass;                                          //  BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        CoreUObject::UObject*                                        ExportRootScope;                                         //  ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        Engine::UAssetExportTask*                                    ExportTask;                                              //  BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
