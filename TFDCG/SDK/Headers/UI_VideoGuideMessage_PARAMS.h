...
namespace CG::UI_VideoGuideMessage
{
     ...
     * Size -> 0x0000
     */
    class UUI_VideoGuideMessage_C_BP_ShowTitle_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class UUI_VideoGuideMessage_C_OnEventWidgetOpen_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class UUI_VideoGuideMessage_C_Construct_Params
    {
    };
     ...
     * Size -> 0x0000
     */
    class UUI_VideoGuideMessage_C_OnEventWidgetClose_Params
    {
    public:
        M1::EM1WidgetAnimDirection                                   InDirection;                                             //  0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
    };
     ...
     * Size -> 0x0000
     */
    class UUI_VideoGuideMessage_C_ExecuteUbergraph_UI_VideoGuideMessage_Params
    {
    public:
