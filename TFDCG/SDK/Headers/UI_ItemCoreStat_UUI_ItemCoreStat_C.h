...
{
    /**
     * WidgetBlueprintGeneratedClass /Game/UI/Components/UI_ItemCoreStat.UI_ItemCoreStat_C
     * Size -> 0x0052 (FullSize[0x07CA] - InheritedSize[0x0778])
     */
    class UUI_ItemCoreStat_C : public M1::UM1UIItemStat
    {
    public:
        ...
        UMG::UScaleBox*                                              ScaleBox_70;                                             //  BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
        ...
        bool                                                         isReactorStat;                                           //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
        bool                                                         isViewLabel;                                             //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash

    public:
        void SetUILayout(bool Vertical);
        void BP_SetDiffStatValue(bool bIsZero, bool bPositiveNum);
        void PreConstruct(bool IsDesignTime);
        void ExecuteUbergraph_UI_ItemCoreStat(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("WidgetBlueprintGeneratedClass /Game/UI/Components/UI_ItemCoreStat.UI_ItemCoreStat_C");
            return ptr;
        }
    };
}
