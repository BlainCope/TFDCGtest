...
{
    /**
     * WidgetBlueprintGeneratedClass /Game/UI/Mission/UI_Mission_Fail.UI_Mission_Fail_C
     * Size -> 0x0028 (FullSize[0x0730] - InheritedSize[0x0708])
     */
    class UUI_Mission_Fail_C : public M1::UM1UIChildMissionGuide
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_UI_Mission_Fail(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("WidgetBlueprintGeneratedClass /Game/UI/Mission/UI_Mission_Fail.UI_Mission_Fail_C");
            return ptr;
        }
    };
}
