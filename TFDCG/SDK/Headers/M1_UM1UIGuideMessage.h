...
{
    /**
     * Class /Script/M1.M1UIGuideMessage
     * Size -> 0x0010 (FullSize[0x0718] - InheritedSize[0x0708])
     */
    class UM1UIGuideMessage : public M1::UM1UIWidget
    {
    public:
        ...
        M1::UM1RichTextBlock*                                        Text_Message;                                            //  ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIGuideMessage");
            return ptr;
        }
    };
}
