...
namespace CG::ControlRig
{
    ...
    {
    public:
        bool                                                         bIsProxy;                                                //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0000[0x7];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        BasicTypes::TArray<ControlRig::FRigElementKey>               DrivenControls;                                          //  Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
