...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/PC/AnimBP/Sec/VAR/BODY/BP_Sec_PC_004_A_VAR_BODY_000.BP_Sec_PC_004_A_VAR_BODY_000_C
     * Size -> 0x0E88 (FullSize[0x11A0] - InheritedSize[0x0318])
     */
    class UBP_Sec_PC_004_A_VAR_BODY_000_C : public Engine::UAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_BP_Sec_PC_004_A_VAR_BODY_000(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/PC/AnimBP/Sec/VAR/BODY/BP_Sec_PC_004_A_VAR_BODY_000.BP_Sec_PC_004_A_VAR_BODY_000_C");
            return ptr;
        }
    };
}
