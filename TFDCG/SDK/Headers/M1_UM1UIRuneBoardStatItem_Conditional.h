...
{
    /**
     * Class /Script/M1.M1UIRuneBoardStatItem_Conditional
     * Size -> 0x0010 (FullSize[0x0718] - InheritedSize[0x0708])
     */
    class UM1UIRuneBoardStatItem_Conditional : public M1::UM1UIWidget
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIRuneBoardStatItem_Conditional");
            return ptr;
        }
    };
}
