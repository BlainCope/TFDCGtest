...
{
    /**
     * Class /Script/M1.M1UIEventTooltip
     * Size -> 0x0018 (FullSize[0x0720] - InheritedSize[0x0708])
     */
    class UM1UIEventTooltip : public M1::UM1UIWidget
    {
    public:
    ...
    public:
        void OnEventClicked_OpenEventPage(M1::UM1UIWidget* InWidget);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIEventTooltip");
            return ptr;
        }
    };
}
