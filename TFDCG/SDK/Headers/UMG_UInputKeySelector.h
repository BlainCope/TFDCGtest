...
namespace CG::UMG
{
     ...
     * Size -> 0x0770 (FullSize[0x08A0] - InheritedSize[0x0130])
     */
    ...
    public:
        ...
        Slate::FInputChord                                           SelectedKey;                                             //  BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic
        SlateCore::FMargin                                           Margin;                                                  //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
        BasicTypes::FText                                            KeySelectionText;                                        //  Edit, BlueprintVisible, NativeAccessSpecifierPublic
        BasicTypes::FText                                            NoKeySpecifiedText;                                      //  Edit, BlueprintVisible, NativeAccessSpecifierPublic
        bool                                                         bAllowModifierKeys;                                      //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bAllowGamepadKeys;                                       //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        BasicTypes::UMulticastInlineDelegate                         OnKeySelected;                                           //  ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0001[0xF];                                   //  FIX WRONG SIZE OF PREVIOUS PROPERTY
        BasicTypes::UMulticastInlineDelegate                         OnIsSelectingKeyChanged;                                 //  ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
