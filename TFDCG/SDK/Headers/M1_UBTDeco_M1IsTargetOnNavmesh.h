...
{
    /**
     * Class /Script/M1.BTDeco_M1IsTargetOnNavmesh
     * Size -> 0x0028 (FullSize[0x0090] - InheritedSize[0x0068])
     */
    class UBTDeco_M1IsTargetOnNavmesh : public M1::UBTDeco_M1Base
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.BTDeco_M1IsTargetOnNavmesh");
            return ptr;
        }
    };
}
