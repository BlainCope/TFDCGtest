...
#include "DeveloperSettings_FPerPlatformSettings.h"
#include "BasicTypes_FString.h"
#include "Engine_ENUMS.h"
#include "Engine_FInputActionKeyMapping.h"
#include "Engine_FInputAxisKeyMapping.h"
#include "Engine_FInputActionSpeechMapping.h"
#include "BasicTypes_TSoftClassPtr.h"
#include "Engine_UPlayerInput.h"
#include "Engine_UInputComponent.h"
...
namespace CG::Engine
{
    ...
    public:
        ...
        DeveloperSettings::FPerPlatformSettings                      PlatformSettings;                                        //  Edit, ContainsInstancedReference, NativeAccessSpecifierPublic
        bool                                                         bEnableMotionControls : 1;                               //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bEnableLegacyInputScales : 1;                            //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bFilterInputByPlatformUser : 1;                          //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bEnableInputDeviceSubsystem : 1;                         //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bShouldFlushPressedKeysOnViewportFocusLost : 1;          //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bEnableDynamicComponentInputBinding : 1;                 //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        bool                                                         bUseAutocorrect : 1;                                     //  BIT_FIELD Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        BasicTypes::TArray<Engine::FInputActionKeyMapping>           ActionMappings;                                          //  Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate
        BasicTypes::TArray<Engine::FInputAxisKeyMapping>             AxisMappings;                                            //  Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate
        BasicTypes::TArray<Engine::FInputActionSpeechMapping>        SpeechMappings;                                          //  Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate
        BasicTypes::TSoftClassPtr<Engine::UPlayerInput>              DefaultPlayerInputClass;                                 //  ELEMENT_SIZE_MISMATCH Edit, Config, NoClear, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        uint8_t                                                      UnknownData_0003[0xC];                                   //  FIX WRONG SIZE OF PREVIOUS PROPERTY
        BasicTypes::TSoftClassPtr<Engine::UInputComponent>           DefaultInputComponentClass;                              //  ELEMENT_SIZE_MISMATCH Edit, Config, NoClear, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
