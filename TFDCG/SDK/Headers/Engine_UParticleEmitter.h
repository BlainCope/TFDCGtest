...
namespace CG::Engine
{
    ...
    public:
        ...
        BasicTypes::TArray<Engine::UParticleLODLevel*>               LODLevels;                                               //  ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic
        ...
        int32_t                                                      DetailModeBitmask;                                       //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0003[0x158];                                 //  MISSED OFFSET (PADDING)
