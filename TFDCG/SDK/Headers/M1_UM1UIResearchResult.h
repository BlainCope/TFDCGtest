...
{
    /**
     * Class /Script/M1.M1UIResearchResult
     * Size -> 0x0008 (FullSize[0x07A8] - InheritedSize[0x07A0])
     */
    class UM1UIResearchResult : public M1::UM1UIPopup
    {
    public:
    ...
    public:
        ...
        void BP_SetDimmedAcrossDelay(M1::UM1UIKeyButton* InKeyButton);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIResearchResult");
            return ptr;
        }
    };
}
