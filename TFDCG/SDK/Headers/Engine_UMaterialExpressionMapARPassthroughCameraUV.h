...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionMapARPassthroughCameraUV : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionMapARPassthroughCameraUV");
            return ptr;
        }
    };
}
