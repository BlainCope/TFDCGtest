...
#include "AkAudio_FAkWinGDKAdvancedInitializationSettings.h"
...
namespace CG::AkAudio
{
     ...
     */
    class UAkWinGDKInitializationSettings : public CoreUObject::UObject
    {
    public:
        ...
        AkAudio::FAkWinGDKAdvancedInitializationSettings             AdvancedSettings;                                        //  Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/AkAudio.AkWinGDKInitializationSettings");
            return ptr;
        }
    };
}
