...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_SphereTraceByTraceChannel : public ControlRig::FRigUnit
    {
    public:
        ...
        Engine::ETraceTypeQuery                                      TraceChannel;                                            //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
