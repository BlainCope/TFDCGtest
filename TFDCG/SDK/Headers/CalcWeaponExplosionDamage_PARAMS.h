...
namespace CG::CalcWeaponExplosionDamage
{
     ...
     * Size -> 0x0000
     */
    class UCalcWeaponExplosionDamage_C_BP_MakeEventObject_Params
    {
    public:
        M1::UM1AbilityEventObject*                                   ReturnValue;                                             //  0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash)
    };
     ...
     * Size -> 0x0000
     */
    class UCalcWeaponExplosionDamage_C_DoCalculation_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class UCalcWeaponExplosionDamage_C_SetAdditionalDamageInfo_Params
    {
    public:
        M1::FM1AbilityOpCalcParam                                    Param;                                                   //  0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
        M1::FM1CalcDamageInfo                                        DamageInfo;                                              //  0x0008(0x0138)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
