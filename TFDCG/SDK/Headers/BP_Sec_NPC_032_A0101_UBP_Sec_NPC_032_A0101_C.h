...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/NPC/032/BP/SEC/BP_Sec_NPC_032_A0101.BP_Sec_NPC_032_A0101_C
     * Size -> 0x0108 (FullSize[0x0420] - InheritedSize[0x0318])
     */
    class UBP_Sec_NPC_032_A0101_C : public Engine::UAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_BP_Sec_NPC_032_A0101(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/NPC/032/BP/SEC/BP_Sec_NPC_032_A0101.BP_Sec_NPC_032_A0101_C");
            return ptr;
        }
    };
}
