...
namespace CG::Engine
{
     ...
     * Size -> 0x0050 (FullSize[0x0240] - InheritedSize[0x01F0])
     */
    class UDecalComponent : public Engine::USceneComponent
    {
    public:
        Engine::UMaterialInterface*                                  DecalMaterial;                                           //  Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
        ...
        CoreUObject::FLinearColor                                    DecalColor;                                              //  Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
    ...
    public:
        ...
        void SetDecalColor(const CoreUObject::FLinearColor& Color);
