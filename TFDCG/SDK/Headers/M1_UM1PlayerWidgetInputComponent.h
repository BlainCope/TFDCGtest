...
{
    /**
     * Class /Script/M1.M1PlayerWidgetInputComponent
     * Size -> 0x0020 (FullSize[0x00C8] - InheritedSize[0x00A8])
     */
    class UM1PlayerWidgetInputComponent : public Engine::UActorComponent
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1PlayerWidgetInputComponent");
            return ptr;
        }
    };
}
