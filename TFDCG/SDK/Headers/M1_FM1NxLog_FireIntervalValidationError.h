...
{
    /**
     * ScriptStruct /Script/M1.M1NxLog_FireIntervalValidationError
     * Size -> 0x00F0
     */
    struct FM1NxLog_FireIntervalValidationError
    {
    public:
        ...
        M1::FM1NxLogInteger                                          validationnum;                                           //  NoDestructor, NativeAccessSpecifierPublic
        M1::FM1NxLogDouble                                           fireinterval;                                            //  NoDestructor, NativeAccessSpecifierPublic
        M1::FM1NxLogDouble                                           avgserverfireinterval;                                   //  NoDestructor, NativeAccessSpecifierPublic
        M1::FM1NxLogDouble                                           avgserverfireintervaldelta;                              //  NoDestructor, NativeAccessSpecifierPublic
        M1::FM1NxLogDouble                                           avgclientfireintervaldelta;                              //  NoDestructor, NativeAccessSpecifierPublic
        M1::FM1NxLogDouble                                           validationrate;                                          //  NoDestructor, NativeAccessSpecifierPublic
    };
}
