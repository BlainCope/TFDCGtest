...
namespace CG::M1FaceMorph
{
     ...
     */
    class UM1FaceMorphData : public Engine::UAssetUserData
    {
    public:
        BasicTypes::TSoftObjectPtr<Engine::USkeletalMesh>            Source;                                                  //  ELEMENT_SIZE_MISMATCH Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1FaceMorph.M1FaceMorphData");
            return ptr;
        }
    };
}
