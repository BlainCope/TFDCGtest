...
namespace CG::MovieSceneCapture
{
    ...
    public:
        ...
        CoreUObject::FSoftClassPath                                  ImageCaptureProtocolType;                                //  Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic
        CoreUObject::FSoftClassPath                                  AudioCaptureProtocolType;                                //  Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic
        MovieSceneCapture::UMovieSceneImageCaptureProtocolBase*      ImageCaptureProtocol;                                    //  Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        MovieSceneCapture::UMovieSceneAudioCaptureProtocolBase*      AudioCaptureProtocol;                                    //  Edit, ExportObject, ZeroConstructor, Transient, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
