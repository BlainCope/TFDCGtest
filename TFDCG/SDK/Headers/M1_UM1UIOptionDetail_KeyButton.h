...
{
    /**
     * Class /Script/M1.M1UIOptionDetail_KeyButton
     * Size -> 0x0010 (FullSize[0x0728] - InheritedSize[0x0718])
     */
    class UM1UIOptionDetail_KeyButton : public M1::UM1UIOptionDetail
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIOptionDetail_KeyButton");
            return ptr;
        }
    };
}
