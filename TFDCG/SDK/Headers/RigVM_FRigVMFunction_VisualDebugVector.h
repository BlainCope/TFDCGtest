...
namespace CG::RigVM
{
     ...
     */
    struct FRigVMFunction_VisualDebugVector : public RigVM::FRigVMFunction_DebugBase
    {
    public:
        ...
        BasicTypes::FName                                            BoneSpace;                                               //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
    };
}
