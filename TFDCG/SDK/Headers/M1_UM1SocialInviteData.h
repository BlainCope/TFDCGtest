...
{
    /**
     * Class /Script/M1.M1SocialInviteData
     * Size -> 0x0048 (FullSize[0x0070] - InheritedSize[0x0028])
     */
    class UM1SocialInviteData : public CoreUObject::UObject
    {
    public:
        M1::EM1SocialInviteType                                      InviteType;                                              //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        ...
        M1Data::EM1FriendUpdateType                                  FriendUpdateType;                                        //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1SocialInviteData");
            return ptr;
        }
    };
}
