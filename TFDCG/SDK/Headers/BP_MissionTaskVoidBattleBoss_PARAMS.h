...
namespace CG::BP_MissionTaskVoidBattleBoss
{
     ...
     * Size -> 0x0000
     */
    class ABP_MissionTaskVoidBattleBoss_C_BP_ShouldBeVisibleOnLocal_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ABP_MissionTaskVoidBattleBoss_C_ExecuteUbergraph_BP_MissionTaskVoidBattleBoss_Params
    {
    public:
