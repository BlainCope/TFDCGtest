...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::FSoundClassProperties                                Properties;                                              //  Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic
        BasicTypes::TArray<Engine::USoundClass*>                     ChildClasses;                                            //  Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic
        ...
        Engine::USoundClass*                                         ParentClass;                                             //  BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
