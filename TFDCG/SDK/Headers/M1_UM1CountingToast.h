...
{
    /**
     * Class /Script/M1.M1CountingToast
     * Size -> 0x0008 (FullSize[0x0070] - InheritedSize[0x0068])
     */
    class UM1CountingToast : public M1::UM1Toast
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1CountingToast");
            return ptr;
        }
    };
}
