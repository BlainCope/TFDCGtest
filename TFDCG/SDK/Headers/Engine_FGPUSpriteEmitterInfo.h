...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::UParticleModuleRequired*                             RequiredModule;                                          //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        Engine::UParticleModuleSpawn*                                SpawnModule;                                             //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        Engine::UParticleModuleSpawnPerUnit*                         SpawnPerUnitModule;                                      //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        BasicTypes::TArray<Engine::UParticleModule*>                 SpawnModules;                                            //  ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic
