...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionShadowReplace : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionShadowReplace");
            return ptr;
        }
    };
}
