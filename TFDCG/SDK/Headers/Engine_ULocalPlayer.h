...
namespace CG::Engine
{
     ...
     * Size -> 0x0230 (FullSize[0x0278] - InheritedSize[0x0048])
     */
    class ULocalPlayer : public Engine::UPlayer
    {
    public:
        uint8_t                                                      UnknownData_0000[0x30];                                  //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        Engine::UGameViewportClient*                                 ViewportClient;                                          //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        Engine::APlayerController*                                   PendingLevelPlayerControllerClass;                       //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        uint8_t                                                      UnknownData_0004[0x1B4];                                 //  MISSED OFFSET (PADDING)
