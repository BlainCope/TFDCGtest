...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::UPrimitiveComponent*                                 GrabbedComponent;                                        //  ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        uint8_t                                                      UnknownData_0003[0x64];                                  //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
