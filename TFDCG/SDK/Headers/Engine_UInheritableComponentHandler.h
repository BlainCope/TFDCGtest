...
namespace CG::Engine
{
    ...
    public:
        ...
        BasicTypes::TArray<Engine::UActorComponent*>                 UnnecessaryComponents;                                   //  ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate
