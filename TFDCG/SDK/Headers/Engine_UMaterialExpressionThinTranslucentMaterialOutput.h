...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionThinTranslucentMaterialOutput : public Engine::UMaterialExpressionCustomOutput
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionThinTranslucentMaterialOutput");
            return ptr;
        }
    };
}
