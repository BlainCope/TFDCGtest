...
namespace CG::AIModule
{
     ...
     */
    class UBTDecorator_TagCooldown : public AIModule::UBTDecorator
    {
    public:
        ...
        bool                                                         bActivatesCooldown;                                      //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
