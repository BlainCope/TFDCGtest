...
{
    /**
     * Class /Script/M1.M1UIGameCodexTrackingDetailSlot
     * Size -> 0x0020 (FullSize[0x0728] - InheritedSize[0x0708])
     */
    class UM1UIGameCodexTrackingDetailSlot : public M1::UM1UIWidget
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIGameCodexTrackingDetailSlot");
            return ptr;
        }
    };
}
