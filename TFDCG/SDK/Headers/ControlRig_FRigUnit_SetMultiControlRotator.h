...
#include "ControlRig_FRigUnit_SetMultiControlRotator_Entry.h"
...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_SetMultiControlRotator : public ControlRig::FRigUnitMutable
    {
    public:
        BasicTypes::TArray<ControlRig::FRigUnit_SetMultiControlRotator_Entry> Entries;                                                 //  Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
