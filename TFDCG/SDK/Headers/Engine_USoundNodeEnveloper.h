...
namespace CG::Engine
{
    ...
    public:
        ...
        Engine::UDistributionFloatConstantCurve*                     VolumeInterpCurve;                                       //  ExportObject, ZeroConstructor, InstancedReference, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        Engine::UDistributionFloatConstantCurve*                     PitchInterpCurve;                                        //  ExportObject, ZeroConstructor, InstancedReference, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
