...
#include "ControlRig_FRigUnit_CCDIK_RotationLimit.h"
...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_CCDIK : public ControlRig::FRigUnit_HighlevelBaseMutable
    {
    public:
        ...
        BasicTypes::TArray<ControlRig::FRigUnit_CCDIK_RotationLimit> RotationLimits;                                          //  Edit, BlueprintVisible, ZeroConstructor, EditConst, NativeAccessSpecifierPublic
