...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionNaniteReplace : public Engine::UMaterialExpression
    {
    public:
        Engine::FExpressionInput                                     Default;                                                 //  NoDestructor, NativeAccessSpecifierPublic
        Engine::FExpressionInput                                     Nanite;                                                  //  NoDestructor, NativeAccessSpecifierPublic
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionNaniteReplace");
            return ptr;
        }
    };
}
