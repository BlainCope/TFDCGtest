...
namespace CG::AugmentedReality
{
     ...
     */
    class UARBaseAsyncTaskBlueprintProxy : public Engine::UBlueprintAsyncActionBase
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/AugmentedReality.ARBaseAsyncTaskBlueprintProxy");
            return ptr;
        }
    };
}
