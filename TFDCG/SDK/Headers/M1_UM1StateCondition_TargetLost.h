...
{
    /**
     * Class /Script/M1.M1StateCondition_TargetLost
     * Size -> 0x0008 (FullSize[0x0040] - InheritedSize[0x0038])
     */
    class UM1StateCondition_TargetLost : public M1::UM1StateCondition
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1StateCondition_TargetLost");
            return ptr;
        }
    };
}
