...
namespace CG::AppleARKit
{
     ...
     */
    class UAppleARKitOcclusionTexture : public AugmentedReality::UARTexture
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/AppleARKit.AppleARKitOcclusionTexture");
            return ptr;
        }
    };
}
