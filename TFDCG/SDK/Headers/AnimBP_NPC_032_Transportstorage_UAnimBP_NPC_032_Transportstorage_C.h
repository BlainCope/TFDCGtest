...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Blueprints/Character/NPC/AnimBP_NPC_032_Transportstorage.AnimBP_NPC_032_Transportstorage_C
     * Size -> 0x0340 (FullSize[0x07F0] - InheritedSize[0x04B0])
     */
    class UAnimBP_NPC_032_Transportstorage_C : public M1::UM1NpcAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_AnimBP_NPC_032_Transportstorage(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Blueprints/Character/NPC/AnimBP_NPC_032_Transportstorage.AnimBP_NPC_032_Transportstorage_C");
            return ptr;
        }
    };
}
