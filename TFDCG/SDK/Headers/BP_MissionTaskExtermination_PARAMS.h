...
namespace CG::BP_MissionTaskExtermination
{
     ...
     * Size -> 0x0000
     */
    class ABP_MissionTaskExtermination_C_BP_ShouldBeVisibleOnLocal_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ABP_MissionTaskExtermination_C_ExecuteUbergraph_BP_MissionTaskExtermination_Params
    {
    public:
