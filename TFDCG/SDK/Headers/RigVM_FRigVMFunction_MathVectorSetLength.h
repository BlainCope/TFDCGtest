...
namespace CG::RigVM
{
     ...
     */
    struct FRigVMFunction_MathVectorSetLength : public RigVM::FRigVMFunction_MathVectorBase
    {
    public:
        ...
        float                                                        Length;                                                  //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
