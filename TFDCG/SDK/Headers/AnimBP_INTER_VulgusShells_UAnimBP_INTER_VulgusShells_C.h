...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Blueprints/InteractionObject/AnimBP_INTER_VulgusShells.AnimBP_INTER_VulgusShells_C
     * Size -> 0x0288 (FullSize[0x05B8] - InheritedSize[0x0330])
     */
    class UAnimBP_INTER_VulgusShells_C : public M1::UM1FieldInteractableActorAnimInstance
    {
    public:
    ...
    public:
        ...
        void EvaluateGraphExposedInputs_ExecuteUbergraph_AnimBP_INTER_VulgusShells_AnimGraphNode_TransitionResult_F625382A4A207083EC3D6C8B144DFE58();
        void ExecuteUbergraph_AnimBP_INTER_VulgusShells(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Blueprints/InteractionObject/AnimBP_INTER_VulgusShells.AnimBP_INTER_VulgusShells_C");
            return ptr;
        }
    };
}
