...
namespace CG::Engine
{
    ...
    public:
        ...
        CoreUObject::FPlane                                          ColorModulate;                                           //  ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        Engine::UTexture2D*                                          GradientTexture0;                                        //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        Engine::UReporterGraph*                                      ReporterGraph;                                           //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
