...
namespace CG::Engine { class UInitialActiveSoundParams; };
...
namespace CG::Engine
{
    ...
    {
    public:
        void STATIC_UnRetainAllSoundsInSoundClass(Engine::USoundClass* InSoundClass);
        void STATIC_UnloadStreamLevelBySoftObjectPtr(CoreUObject::UObject* WorldContextObject, BasicTypes::TSoftObjectPtr<Engine::UWorld> Level, const Engine::FLatentActionInfo& LatentInfo, bool bShouldBlockOnUnload);
        ...
        Engine::UParticleSystemComponent* STATIC_SpawnEmitterAtLocation(CoreUObject::UObject* WorldContextObject, Engine::UParticleSystem* EmitterTemplate, const CoreUObject::FVector& Location, const CoreUObject::FRotator& Rotation, const CoreUObject::FVector& Scale, bool bAutoDestroy, Engine::EPSCPoolMethod PoolingMethod, bool bAutoActivateSystem, float CustomEmitterDelay);
        ...
        void STATIC_SetViewportMouseCaptureMode(CoreUObject::UObject* WorldContextObject, Engine::EMouseCaptureMode MouseCaptureMode);
        ...
        void STATIC_SetSoundClassDistanceScale(CoreUObject::UObject* WorldContextObject, Engine::USoundClass* SoundClass, float DistanceAttenuationScale, float TimeSec);
        void STATIC_SetPlayerPlatformUserId(Engine::APlayerController* PlayerController, const CoreUObject::FPlatformUserId& UserId);
        void STATIC_SetPlayerControllerID(Engine::APlayerController* Player, int32_t ControllerId);
        void STATIC_SetMaxAudioChannelsScaled(CoreUObject::UObject* WorldContextObject, float MaxChannelCountScale);
        ...
        void STATIC_SetForceDisableSplitscreen(CoreUObject::UObject* WorldContextObject, bool bDisable);
        ...
        bool STATIC_SetActiveSpatialPluginByName(CoreUObject::UObject* WorldContextObject, const BasicTypes::FName& InPluginName);
        ...
        void STATIC_PrimeSound(Engine::USoundBase* InSound);
        void STATIC_PrimeAllSoundsInSoundClass(Engine::USoundClass* InSoundClass);
        void STATIC_PopSoundMixModifier(CoreUObject::UObject* WorldContextObject, Engine::USoundMix* InSoundMixModifier);
        void STATIC_PlayWorldCameraShake(CoreUObject::UObject* WorldContextObject, Engine::UCameraShakeBase* Shake, const CoreUObject::FVector& Epicenter, float InnerRadius, float OuterRadius, float Falloff, bool bOrientShakeTowardsEpicenter);
        void STATIC_PlaySoundAtLocation(CoreUObject::UObject* WorldContextObject, Engine::USoundBase* Sound, const CoreUObject::FVector& Location, const CoreUObject::FRotator& Rotation, float VolumeMultiplier, float PitchMultiplier, float StartTime, Engine::USoundAttenuation* AttenuationSettings, Engine::USoundConcurrency* ConcurrencySettings, Engine::AActor* OwningActor, Engine::UInitialActiveSoundParams* InitialParams);
        void STATIC_PlaySound2D(CoreUObject::UObject* WorldContextObject, Engine::USoundBase* Sound, float VolumeMultiplier, float PitchMultiplier, float StartTime, Engine::USoundConcurrency* ConcurrencySettings, Engine::AActor* OwningActor, bool bIsUISound);
        ...
        void STATIC_OpenLevelBySoftObjectPtr(CoreUObject::UObject* WorldContextObject, BasicTypes::TSoftObjectPtr<Engine::UWorld> Level, bool bAbsolute, const BasicTypes::FString& Options);
        ...
        bool STATIC_ObjectIsA(CoreUObject::UObject* Object, CoreUObject::UObject* ObjectClass);
        Engine::FHitResult STATIC_MakeHitResult(bool bBlockingHit, bool bInitialOverlap, float Time, float Distance, const CoreUObject::FVector& Location, const CoreUObject::FVector& ImpactPoint, const CoreUObject::FVector& Normal, const CoreUObject::FVector& ImpactNormal, PhysicsCore::UPhysicalMaterial* PhysMat, Engine::AActor* HitActor, Engine::UPrimitiveComponent* HitComponent, const BasicTypes::FName& HitBoneName, const BasicTypes::FName& BoneName, int32_t HitItem, int32_t ElementIndex, int32_t FaceIndex, const CoreUObject::FVector& TraceStart, const CoreUObject::FVector& TraceEnd);
        void STATIC_LoadStreamLevelBySoftObjectPtr(CoreUObject::UObject* WorldContextObject, BasicTypes::TSoftObjectPtr<Engine::UWorld> Level, bool bMakeVisibleAfterLoad, bool bShouldBlockOnLoad, const Engine::FLatentActionInfo& LatentInfo);
        ...
        bool STATIC_IsSplitscreenForceDisabled(CoreUObject::UObject* WorldContextObject);
        ...
        double STATIC_GetWorldDeltaSeconds(CoreUObject::UObject* WorldContextObject);
        void STATIC_GetViewProjectionMatrix(const Engine::FMinimalViewInfo& DesiredView, CoreUObject::FMatrix* ViewMatrix, CoreUObject::FMatrix* ProjectionMatrix, CoreUObject::FMatrix* ViewProjectionMatrix);
        Engine::EMouseCaptureMode STATIC_GetViewportMouseCaptureMode(CoreUObject::UObject* WorldContextObject);
        double STATIC_GetUnpausedTimeSeconds(CoreUObject::UObject* WorldContextObject);
        double STATIC_GetTimeSeconds(CoreUObject::UObject* WorldContextObject);
        PhysicsCore::EPhysicalSurface STATIC_GetSurfaceType(const Engine::FHitResult& Hit);
        ...
        double STATIC_GetRealTimeSeconds(CoreUObject::UObject* WorldContextObject);
        Engine::APlayerState* STATIC_GetPlayerStateFromUniqueNetId(CoreUObject::UObject* WorldContextObject, const Engine::FUniqueNetIdRepl& UniqueId);
        Engine::APlayerState* STATIC_GetPlayerState(CoreUObject::UObject* WorldContextObject, int32_t PlayerStateIndex);
        ...
        Engine::APlayerController* STATIC_GetPlayerControllerFromPlatformUser(CoreUObject::UObject* WorldContextObject, const CoreUObject::FPlatformUserId& UserId);
        Engine::APlayerController* STATIC_GetPlayerControllerFromID(CoreUObject::UObject* WorldContextObject, int32_t ControllerId);
        ...
        int32_t STATIC_GetNumPlayerStates(CoreUObject::UObject* WorldContextObject);
        int32_t STATIC_GetNumPlayerControllers(CoreUObject::UObject* WorldContextObject);
        int32_t STATIC_GetNumLocalPlayerControllers(CoreUObject::UObject* WorldContextObject);
        int32_t STATIC_GetMaxAudioChannelCount(CoreUObject::UObject* WorldContextObject);
        ...
        bool STATIC_GetClosestListenerLocation(CoreUObject::UObject* WorldContextObject, const CoreUObject::FVector& Location, float MaximumRange, bool bAllowAttenuationOverride, CoreUObject::FVector* ListenerPosition);
        BasicTypes::TArray<BasicTypes::FName> STATIC_GetAvailableSpatialPluginNames(CoreUObject::UObject* WorldContextObject);
        double STATIC_GetAudioTimeSeconds(CoreUObject::UObject* WorldContextObject);
        ...
        void STATIC_GetAllActorsOfClassWithTag(CoreUObject::UObject* WorldContextObject, Engine::AActor* ActorClass, const BasicTypes::FName& Tag, BasicTypes::TArray<Engine::AActor*>* OutActors);
        ...
        Engine::AActor* STATIC_GetActorOfClass(CoreUObject::UObject* WorldContextObject, Engine::AActor* ActorClass);
        ...
        BasicTypes::FName STATIC_GetActiveSpatialPluginName(CoreUObject::UObject* WorldContextObject);
        void STATIC_GetAccurateRealTime(int32_t* Seconds, double* PartialSeconds);
        void STATIC_FlushLevelStreaming(CoreUObject::UObject* WorldContextObject);
        Engine::AActor* STATIC_FinishSpawningActor(Engine::AActor* Actor, const CoreUObject::FTransform& SpawnTransform, Engine::ESpawnActorScaleMethod TransformScaleMethod);
        Engine::AActor* STATIC_FindNearestActor(const CoreUObject::FVector& Origin, BasicTypes::TArray<Engine::AActor*> ActorsToCheck, float* Distance);
        ...
        bool STATIC_DeprojectSceneCaptureToWorld(Engine::ASceneCapture2D* SceneCapture2D, const CoreUObject::FVector2D& TargetUV, CoreUObject::FVector* WorldPosition, CoreUObject::FVector* WorldDirection);
        ...
        Engine::APlayerController* STATIC_CreatePlayerFromPlatformUser(CoreUObject::UObject* WorldContextObject, const CoreUObject::FPlatformUserId& UserId, bool bSpawnPlayerController);
        Engine::APlayerController* STATIC_CreatePlayer(CoreUObject::UObject* WorldContextObject, int32_t ControllerId, bool bSpawnPlayerController);
        ...
        void STATIC_BreakHitResult(const Engine::FHitResult& Hit, bool* bBlockingHit, bool* bInitialOverlap, float* Time, float* Distance, CoreUObject::FVector* Location, CoreUObject::FVector* ImpactPoint, CoreUObject::FVector* Normal, CoreUObject::FVector* ImpactNormal, PhysicsCore::UPhysicalMaterial** PhysMat, Engine::AActor** HitActor, Engine::UPrimitiveComponent** HitComponent, BasicTypes::FName* HitBoneName, BasicTypes::FName* BoneName, int32_t* HitItem, int32_t* ElementIndex, int32_t* FaceIndex, CoreUObject::FVector* TraceStart, CoreUObject::FVector* TraceEnd);
        ...
        Engine::AActor* STATIC_BeginDeferredActorSpawnFromClass(CoreUObject::UObject* WorldContextObject, Engine::AActor* ActorClass, const CoreUObject::FTransform& SpawnTransform, Engine::ESpawnActorCollisionHandlingMethod CollisionHandlingOverride, Engine::AActor* Owner, Engine::ESpawnActorScaleMethod TransformScaleMethod);
        ...
        void STATIC_AnnounceAccessibleString(const BasicTypes::FString& AnnouncementString);
