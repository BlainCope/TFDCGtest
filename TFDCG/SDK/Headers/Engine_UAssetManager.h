...
namespace CG::Engine
{
    ...
    {
    public:
        uint8_t                                                      UnknownData_0000[0x308];                                 //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        BasicTypes::TArray<CoreUObject::UObject*>                    ObjectReferenceList;                                     //  ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected
        ...
        int32_t                                                      NumBulkScanRequests;                                     //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        ...
        bool                                                         bHasCompletedInitialScan;                                //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        ...
        uint8_t                                                      UnknownData_0003[0x178];                                 //  MISSED OFFSET (PADDING)
