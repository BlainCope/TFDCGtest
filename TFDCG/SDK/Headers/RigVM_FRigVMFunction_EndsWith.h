...
namespace CG::RigVM
{
     ...
     */
    struct FRigVMFunction_EndsWith : public RigVM::FRigVMFunction_NameBase
    {
    public:
        ...
        BasicTypes::FName                                            Ending;                                                  //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
