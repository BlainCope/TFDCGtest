...
namespace CG::GeometryCollectionEngine
{
    ...
    public:
        ...
        float                                                        MinRadius;                                               //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        GeometryCollectionEngine::EChaosBreakingSortMethod           SortMethod;                                              //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
