...
namespace CG::CableComponent
{
     ...
     * Size -> 0x0090 (FullSize[0x0540] - InheritedSize[0x04B0])
     */
    class UCableComponent : public Engine::UMeshComponent
    {
    public:
        bool                                                         bAttachStart;                                            //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bAttachEnd;                                              //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0000[0x6];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        Engine::FComponentReference                                  AttachEndTo;                                             //  Edit, NativeAccessSpecifierPublic
        ...
        bool                                                         bUseSubstepping;                                         //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bSkipCableUpdateWhenNotVisible;                          //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
        bool                                                         bSkipCableUpdateWhenNotOwnerRecentlyRendered;            //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
