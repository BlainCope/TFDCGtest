...
namespace CG::AnimGraphRuntime
{
    ...
    {
    public:
        AnimGraphRuntime::EWarpingVectorMode                         Mode;                                                    //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
