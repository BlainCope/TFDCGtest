...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionStrataUI : public Engine::UMaterialExpressionStrataBSDF
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionStrataUI");
            return ptr;
        }
    };
}
