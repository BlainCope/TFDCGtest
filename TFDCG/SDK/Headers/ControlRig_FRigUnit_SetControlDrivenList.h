...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_SetControlDrivenList : public ControlRig::FRigUnitMutable
    {
    public:
        ...
        BasicTypes::TArray<ControlRig::FRigElementKey>               Driven;                                                  //  Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
