...
namespace CG::Engine
{
    ...
    public:
        ...
        Engine::APlayerCameraManager*                                CameraOwner;                                             //  BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        void OnCameraOwnerDestroyed(Engine::AActor* InOwner);
        bool IsDisabled();
