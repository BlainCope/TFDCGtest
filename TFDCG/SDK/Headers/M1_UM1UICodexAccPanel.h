...
{
    /**
     * Class /Script/M1.M1UICodexAccPanel
     * Size -> 0x0020 (FullSize[0x0738] - InheritedSize[0x0718])
     */
    class UM1UICodexAccPanel : public M1::UM1UICodexItemPanelBase
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UICodexAccPanel");
            return ptr;
        }
    };
}
