...
{
    /**
     * Class /Script/M1.M1UIWeaponCustomizeEntry
     * Size -> 0x0008 (FullSize[0x08B0] - InheritedSize[0x08A8])
     */
    class UM1UIWeaponCustomizeEntry : public M1::UM1UIButton
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIWeaponCustomizeEntry");
            return ptr;
        }
    };
}
