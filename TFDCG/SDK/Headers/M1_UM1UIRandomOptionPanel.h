...
{
    /**
     * Class /Script/M1.M1UIRandomOptionPanel
     * Size -> 0x0018 (FullSize[0x0A70] - InheritedSize[0x0A58])
     */
    class UM1UIRandomOptionPanel : public M1::UM1UIPanelEntries
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIRandomOptionPanel");
            return ptr;
        }
    };
}
