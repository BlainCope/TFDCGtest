...
namespace CG::EngineSettings
{
    ...
    public:
        ...
        float                                                        EyeOffsetForFakeStereoRenderingDevice;                   //  Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        float                                                        FOVForFakeStereoRenderingDevice;                         //  Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
