...
#include "M1_UM1WireCasterAnimInstance.h"
...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/Weapon/WireCaster/WC_AnimBP.WC_AnimBP_C
     * Size -> 0x0340 (FullSize[0x0670] - InheritedSize[0x0330])
     */
    class UWC_AnimBP_C : public M1::UM1WireCasterAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_WC_AnimBP(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/Weapon/WireCaster/WC_AnimBP.WC_AnimBP_C");
            return ptr;
        }
    };
}
