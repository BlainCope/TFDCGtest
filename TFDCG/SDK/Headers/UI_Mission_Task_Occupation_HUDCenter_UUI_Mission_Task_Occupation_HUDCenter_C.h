...
{
    /**
     * WidgetBlueprintGeneratedClass /Game/UI/Mission/Widgets/UI_Mission_Task_Occupation_HUDCenter.UI_Mission_Task_Occupation_HUDCenter_C
     * Size -> 0x0029 (FullSize[0x0781] - InheritedSize[0x0758])
     */
    class UUI_Mission_Task_Occupation_HUDCenter_C : public M1::UM1UIMissionTaskGoal_Occupation
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_UI_Mission_Task_Occupation_HUDCenter(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("WidgetBlueprintGeneratedClass /Game/UI/Mission/Widgets/UI_Mission_Task_Occupation_HUDCenter.UI_Mission_Task_Occupation_HUDCenter_C");
            return ptr;
        }
    };
}
