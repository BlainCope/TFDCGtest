...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionStrataWeight : public Engine::UMaterialExpressionStrataBSDF
    {
    public:
        Engine::FExpressionInput                                     A;                                                       //  NoDestructor, NativeAccessSpecifierPublic
        Engine::FExpressionInput                                     Weight;                                                  //  NoDestructor, NativeAccessSpecifierPublic
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionStrataWeight");
            return ptr;
        }
    };
}
