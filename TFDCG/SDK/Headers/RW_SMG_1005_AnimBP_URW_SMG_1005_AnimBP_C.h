...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/Weapon/RW/SMG/1005/RW_SMG_1005_AnimBP.RW_SMG_1005_AnimBP_C
     * Size -> 0x0260 (FullSize[0x0578] - InheritedSize[0x0318])
     */
    class URW_SMG_1005_AnimBP_C : public Engine::UAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_RW_SMG_1005_AnimBP(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/Weapon/RW/SMG/1005/RW_SMG_1005_AnimBP.RW_SMG_1005_AnimBP_C");
            return ptr;
        }
    };
}
