...
{
    /**
     * Class /Script/M1.M1PartyInviteData
     * Size -> 0x0058 (FullSize[0x0080] - InheritedSize[0x0028])
     */
    class UM1PartyInviteData : public CoreUObject::UObject
    {
    public:
        ...
        int64_t                                                      MasteryLevel;                                            //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        M1Data::FM1TemplateId                                        CharacterTid;                                            //  NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        uint8_t                                                      UnknownData_0001[0x4];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        int64_t                                                      CharacterLevel;                                          //  ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        CoreUObject::FDateTime                                       ReceivedDate;                                            //  ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1PartyInviteData");
            return ptr;
        }
    };
}
