...
{
    /**
     * Class /Script/M1.M1UICustomizeUINameTag
     * Size -> 0x0008 (FullSize[0x08D0] - InheritedSize[0x08C8])
     */
    class UM1UICustomizeUINameTag : public M1::UM1UICustomizePageBase
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UICustomizeUINameTag");
            return ptr;
        }
    };
}
