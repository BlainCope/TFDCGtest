...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_ConvertEulerTransform : public ControlRig::FRigUnit
    {
    public:
        AnimationCore::FEulerTransform                               Input;                                                   //  Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic
