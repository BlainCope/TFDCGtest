...
namespace CG::SequencerScripting
{
     ...
     */
    class UMovieSceneScriptingDoubleChannel : public SequencerScripting::UMovieSceneScriptingChannel
    {
    public:
    ...
    public:
        ...
        double GetDefault();
        BasicTypes::TArray<double> EvaluateKeys(const SequencerScripting::FSequencerScriptingRange& Range, const CoreUObject::FFrameRate& FrameRate);
        SequencerScripting::FSequencerScriptingRange ComputeEffectiveRange();
        SequencerScripting::UMovieSceneScriptingDoubleKey* AddKey(const CoreUObject::FFrameNumber& InTime, double NewValue, float SubFrame, SequencerScripting::ESequenceTimeUnit TimeUnit, MovieScene::EMovieSceneKeyInterpolation InInterpolation);
