...
namespace CG::Engine
{
    ...
    public:
        ...
        uint8_t                                                      CompressedPing;                                          //  BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        ...
        Engine::ULocalMessage*                                       EngineMessageClass;                                      //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        BasicTypes::UMulticastInlineDelegate                         OnPawnSet;                                               //  ELEMENT_SIZE_MISMATCH ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0005[0xF];                                   //  FIX WRONG SIZE OF PREVIOUS PROPERTY
        Engine::APawn*                                               PawnPrivate;                                             //  BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        uint8_t                                                      UnknownData_0006[0x78];                                  //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        BasicTypes::FString                                          PlayerNamePrivate;                                       //  Net, ZeroConstructor, RepNotify, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        uint8_t                                                      UnknownData_0007[0x10];                                  //  MISSED OFFSET (PADDING)
    ...
    public:
        ...
        void OnPawnPrivateDestroyed(Engine::AActor* InActor);
        bool IsSpectator();
        ...
        Engine::APawn* GetPawn();
        uint8_t GetCompressedPing();
        Engine::FUniqueNetIdRepl BP_GetUniqueId();
