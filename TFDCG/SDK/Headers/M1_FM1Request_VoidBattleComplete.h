...
{
    /**
     * ScriptStruct /Script/M1.M1Request_VoidBattleComplete
     * Size -> 0x0018
     */
    struct FM1Request_VoidBattleComplete : public M1::FM1Request
    {
    public:
        ...
        int32_t                                                      VoidBattleTId;                                           //  ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
