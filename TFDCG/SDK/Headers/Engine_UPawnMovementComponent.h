...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::APawn*                                               PawnOwner;                                               //  ZeroConstructor, Transient, DuplicateTransient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
