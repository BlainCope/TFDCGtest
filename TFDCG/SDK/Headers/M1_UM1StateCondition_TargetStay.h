...
{
    /**
     * Class /Script/M1.M1StateCondition_TargetStay
     * Size -> 0x0018 (FullSize[0x0050] - InheritedSize[0x0038])
     */
    class UM1StateCondition_TargetStay : public M1::UM1StateCondition
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1StateCondition_TargetStay");
            return ptr;
        }
    };
}
