...
namespace CG::CalcATKBaseSkillRecovery
{
     ...
     * Size -> 0x0000
     */
    class UCalcATKBaseSkillRecovery_C_ApplyHealRatio_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class UCalcATKBaseSkillRecovery_C_SetRecoveryOutModifier_Params
    {
    public:
        M1::FM1AbilityOpCalcParam                                    Param;                                                   //  0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
        M1::FM1CalcDamageInfo                                        DamageInfo;                                              //  0x0008(0x0138)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
     ...
     * Size -> 0x0000
     */
    class UCalcATKBaseSkillRecovery_C_DoCalculation_Params
    {
    public:
        M1::FM1AbilityOpCalcParam                                    Param;                                                   //  0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
        M1::FM1CalcDamageInfo                                        DamageInfo;                                              //  0x0008(0x0138)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
