...
namespace CG::Engine
{
    ...
    public:
        ...
        Engine::USkeletalMeshComponent*                              SkeletalMeshComponent;                                   //  ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
