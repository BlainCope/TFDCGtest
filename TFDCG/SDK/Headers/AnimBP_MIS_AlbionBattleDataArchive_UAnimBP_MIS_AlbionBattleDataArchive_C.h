...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Mission/TargetActor/Static/MIS_AlbionBattleDataArchive/BP/AnimBP_MIS_AlbionBattleDataArchive.AnimBP_MIS_AlbionBattleDataArchive_C
     * Size -> 0x0340 (FullSize[0x0660] - InheritedSize[0x0320])
     */
    class UAnimBP_MIS_AlbionBattleDataArchive_C : public M1::UM1MissionTargetAnimInstance
    {
    public:
    ...
    public:
        ...
        void EvaluateGraphExposedInputs_ExecuteUbergraph_AnimBP_MIS_AlbionBattleDataArchive_AnimGraphNode_TransitionResult_C8009E744CAEB0CDEF09D99E094B3B5E();
        void EvaluateGraphExposedInputs_ExecuteUbergraph_AnimBP_MIS_AlbionBattleDataArchive_AnimGraphNode_TransitionResult_71E2F98240288DBC25B1F08D8CB017B9();
        void ExecuteUbergraph_AnimBP_MIS_AlbionBattleDataArchive(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Mission/TargetActor/Static/MIS_AlbionBattleDataArchive/BP/AnimBP_MIS_AlbionBattleDataArchive.AnimBP_MIS_AlbionBattleDataArchive_C");
            return ptr;
        }
    };
}
