...
namespace CG::UMG
{
    ...
    public:
        ...
        void STATIC_SetInputMode_UIOnlyEx(Engine::APlayerController* PlayerController, UMG::UWidget* InWidgetToFocus, Engine::EMouseLockMode InMouseLockMode, bool bFlushInput);
        void STATIC_SetInputMode_GameOnly(Engine::APlayerController* PlayerController, bool bFlushInput);
        void STATIC_SetInputMode_GameAndUIEx(Engine::APlayerController* PlayerController, UMG::UWidget* InWidgetToFocus, Engine::EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, bool bFlushInput);
        ...
        void STATIC_GetAllWidgetsWithInterface(CoreUObject::UObject* WorldContextObject, BasicTypes::TArray<UMG::UUserWidget*>* FoundWidgets, CoreUObject::IInterface* Interface, bool TopLevelOnly);
        ...
        void STATIC_DrawSpline(UMG::FPaintContext* Context, const CoreUObject::FVector2D& Start, const CoreUObject::FVector2D& StartDir, const CoreUObject::FVector2D& End, const CoreUObject::FVector2D& EndDir, const CoreUObject::FLinearColor& Tint, float Thickness);
        void STATIC_DrawLines(UMG::FPaintContext* Context, BasicTypes::TArray<CoreUObject::FVector2D> Points, const CoreUObject::FLinearColor& Tint, bool bAntiAlias, float Thickness);
        void STATIC_DrawLine(UMG::FPaintContext* Context, const CoreUObject::FVector2D& PositionA, const CoreUObject::FVector2D& PositionB, const CoreUObject::FLinearColor& Tint, bool bAntiAlias, float Thickness);
