...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::APlayerController*                                   PlayerOwner;                                             //  BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        BasicTypes::TArray<Engine::AActor*>                          PostRenderedActors;                                      //  ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic
        ...
        Engine::UCanvas*                                             Canvas;                                                  //  ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
        Engine::UCanvas*                                             DebugCanvas;                                             //  ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
        BasicTypes::TArray<Engine::FDebugTextInfo>                   DebugTextList;                                           //  ZeroConstructor, Protected, NativeAccessSpecifierProtected
        Engine::AActor*                                              ShowDebugTargetDesiredClass;                             //  ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
        Engine::AActor*                                              ShowDebugTargetActor;                                    //  ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        ...
        CoreUObject::FVector Project(const CoreUObject::FVector& Location, bool bClampToZeroPlane);
