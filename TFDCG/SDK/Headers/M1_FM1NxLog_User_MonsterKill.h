...
{
    /**
     * ScriptStruct /Script/M1.M1NxLog_User_MonsterKill
     * Size -> 0x00A0
     */
    struct FM1NxLog_User_MonsterKill
    {
    public:
        ...
        BasicTypes::FString                                          MonsterId;                                               //  ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        M1::FM1NxLogInteger                                          MonsterLevel;                                            //  NoDestructor, NativeAccessSpecifierPublic
        BasicTypes::FString                                          monstertype;                                             //  ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
