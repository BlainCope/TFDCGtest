...
{
    /**
     * ScriptStruct /Script/M1Data.M1MissionTaskSubData
     * Size -> 0x0068 (FullSize[0x0070] - InheritedSize[0x0008])
     */
    struct FM1MissionTaskSubData : public Engine::FTableRowBase
    {
    public:
        ...
        BasicTypes::FName                                            OptionalStringId;                                        //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        int32_t                                                      TaskSuccessScore;                                        //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        BasicTypes::FName                                            TaskDropCollection;                                      //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        BasicTypes::FName                                            TaskDropSupply;                                          //  Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
