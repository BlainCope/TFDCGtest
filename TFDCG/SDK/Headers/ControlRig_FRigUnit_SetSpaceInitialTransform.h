...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_SetSpaceInitialTransform : public ControlRig::FRigUnitMutable
    {
    public:
        BasicTypes::FName                                            SpaceName;                                               //  Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
