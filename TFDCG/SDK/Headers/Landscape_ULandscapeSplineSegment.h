...
namespace CG::Landscape
{
    ...
    public:
        ...
        BasicTypes::TArray<Engine::USplineMeshComponent*>            LocalMeshComponents;                                     //  ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, TextExportTransient, UObjectWrapper, NativeAccessSpecifierProtected
