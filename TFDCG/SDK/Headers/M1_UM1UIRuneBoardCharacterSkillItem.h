...
{
    /**
     * Class /Script/M1.M1UIRuneBoardCharacterSkillItem
     * Size -> 0x0000 (FullSize[0x0708] - InheritedSize[0x0708])
     */
    class UM1UIRuneBoardCharacterSkillItem : public M1::UM1UIWidget
    {
    public:
        ...
        void BP_OnSkillRedirected(bool bIsChanged);
        void BP_OnSkillDetailChanged(bool bIsChanged);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1UIRuneBoardCharacterSkillItem");
            return ptr;
        }
    };
}
