...
#include "AkAudio_FAkWindowsAdvancedInitializationSettings.h"
...
namespace CG::AkAudio
{
     ...
     */
    class UAkWindowsInitializationSettings : public CoreUObject::UObject
    {
    public:
        ...
        AkAudio::FAkWindowsAdvancedInitializationSettings            AdvancedSettings;                                        //  Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/AkAudio.AkWindowsInitializationSettings");
            return ptr;
        }
    };
}
