...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/PC/AnimBP/Sec/VAR/HEAD/BP_Sec_PC_013_A_VAR_HEAD_000.BP_Sec_PC_013_A_VAR_HEAD_000_C
     * Size -> 0x1040 (FullSize[0x1380] - InheritedSize[0x0340])
     */
    class UBP_Sec_PC_013_A_VAR_HEAD_000_C : public M1::UM1BaseAttachmentAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_BP_Sec_PC_013_A_VAR_HEAD_000(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/PC/AnimBP/Sec/VAR/HEAD/BP_Sec_PC_013_A_VAR_HEAD_000.BP_Sec_PC_013_A_VAR_HEAD_000_C");
            return ptr;
        }
    };
}
