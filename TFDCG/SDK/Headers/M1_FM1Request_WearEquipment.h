...
{
    /**
     * ScriptStruct /Script/M1.M1Request_WearEquipment
     * Size -> 0x0018
     */
    struct FM1Request_WearEquipment : public M1::FM1Request
    {
    public:
        int64_t                                                      AccountUid;                                              //  ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        int64_t                                                      EquipmentUid;                                            //  ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
