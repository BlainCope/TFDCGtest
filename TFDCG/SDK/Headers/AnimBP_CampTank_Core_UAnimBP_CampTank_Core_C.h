...
{
    /**
     * AnimBlueprintGeneratedClass /Game/BG/BG_AnimBP/Camp/AnimBP_CampTank_Core.AnimBP_CampTank_Core_C
     * Size -> 0x02D8 (FullSize[0x0608] - InheritedSize[0x0330])
     */
    class UAnimBP_CampTank_Core_C : public M1::UM1CampAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_AnimBP_CampTank_Core(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/BG/BG_AnimBP/Camp/AnimBP_CampTank_Core.AnimBP_CampTank_Core_C");
            return ptr;
        }
    };
}
