...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionAbsorptionMediumMaterialOutput : public Engine::UMaterialExpressionCustomOutput
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionAbsorptionMediumMaterialOutput");
            return ptr;
        }
    };
}
