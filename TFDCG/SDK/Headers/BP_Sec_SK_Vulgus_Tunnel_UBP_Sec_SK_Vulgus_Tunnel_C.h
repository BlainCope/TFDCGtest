...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/Prop/Prop_ANI/Vulgus_Tunnel/BP/SEC/BP_Sec_SK_Vulgus_Tunnel.BP_Sec_SK_Vulgus_Tunnel_C
     * Size -> 0x0108 (FullSize[0x0420] - InheritedSize[0x0318])
     */
    class UBP_Sec_SK_Vulgus_Tunnel_C : public Engine::UAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_BP_Sec_SK_Vulgus_Tunnel(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/Prop/Prop_ANI/Vulgus_Tunnel/BP/SEC/BP_Sec_SK_Vulgus_Tunnel.BP_Sec_SK_Vulgus_Tunnel_C");
            return ptr;
        }
    };
}
