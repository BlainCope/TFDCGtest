...
namespace CG::Engine { class UCheatManagerExtension; };
...
namespace CG::Engine
{
    ...
    {
    public:
        Engine::ADebugCameraController*                              DebugCameraControllerRef;                                //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        Engine::ADebugCameraController*                              DebugCameraControllerClass;                              //  Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0000[0x40];                                  //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        BasicTypes::TArray<Engine::UCheatManagerExtension*>          CheatManagerExtensions;                                  //  ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected
    ...
    public:
        ...
        void ReceiveEndPlay();
        void PlayersOnly();
        void OnPlayerEndPlayed(Engine::AActor* Player, Engine::EEndPlayReason EndPlayReason);
