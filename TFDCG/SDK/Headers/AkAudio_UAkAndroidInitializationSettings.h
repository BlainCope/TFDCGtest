...
#include "AkAudio_FAkAndroidAdvancedInitializationSettings.h"
...
namespace CG::AkAudio
{
     ...
     */
    class UAkAndroidInitializationSettings : public CoreUObject::UObject
    {
    public:
        ...
        AkAudio::FAkAndroidAdvancedInitializationSettings            AdvancedSettings;                                        //  Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/AkAudio.AkAndroidInitializationSettings");
            return ptr;
        }
    };
}
