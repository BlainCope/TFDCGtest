...
namespace CG::ProceduralMeshComponent
{
    ...
    public:
        ...
        bool                                                         bUseWireProxy;                                           //  Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
        uint8_t                                                      UnknownData_0001[0x5];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        Engine::UBodySetup*                                          ProcMeshBodySetup;                                       //  ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        BasicTypes::TArray<Engine::UBodySetup*>                      AsyncBodySetupQueue;                                     //  ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate
