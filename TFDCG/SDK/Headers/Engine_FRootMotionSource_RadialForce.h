...
namespace CG::Engine
{
    ...
    public:
        ...
        Engine::AActor*                                              LocationActor;                                           //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        Engine::UCurveFloat*                                         StrengthDistanceFalloff;                                 //  ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic
