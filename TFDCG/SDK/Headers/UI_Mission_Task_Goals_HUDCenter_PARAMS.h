...
namespace CG::UI_Mission_Task_Goals_HUDCenter
{
     ...
     * Size -> 0x0000
     */
    class UUI_Mission_Task_Goals_HUDCenter_C_SetDataImpl_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class UUI_Mission_Task_Goals_HUDCenter_C_ExecuteUbergraph_UI_Mission_Task_Goals_HUDCenter_Params
    {
    public:
