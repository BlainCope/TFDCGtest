...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionStrataSimpleClearCoatBSDF : public Engine::UMaterialExpressionStrataBSDF
    {
    public:
        ...
        Engine::FExpressionInput                                     ClearCoatCoverage;                                       //  NoDestructor, NativeAccessSpecifierPublic
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionStrataSimpleClearCoatBSDF");
            return ptr;
        }
    };
}
