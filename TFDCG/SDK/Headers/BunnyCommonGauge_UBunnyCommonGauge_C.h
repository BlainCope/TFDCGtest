...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Gameplay/Common/Calculation/Special/BunnyCommonGauge.BunnyCommonGauge_C
     * Size -> 0x0009 (FullSize[0x0101] - InheritedSize[0x00F8])
     */
    class UBunnyCommonGauge_C : public CalcEtcBase::UCalcEtcBase_C
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Gameplay/Common/Calculation/Special/BunnyCommonGauge.BunnyCommonGauge_C");
            return ptr;
        }
    };
}
