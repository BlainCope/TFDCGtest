...
{
    /**
     * AnimBlueprintGeneratedClass /Game/Characters/Weapon/WireCaster/WC_Hook_AnimBP.WC_Hook_AnimBP_C
     * Size -> 0x0368 (FullSize[0x0698] - InheritedSize[0x0330])
     */
    class UWC_Hook_AnimBP_C : public M1::UM1WireCasterAnimInstance
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_WC_Hook_AnimBP(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("AnimBlueprintGeneratedClass /Game/Characters/Weapon/WireCaster/WC_Hook_AnimBP.WC_Hook_AnimBP_C");
            return ptr;
        }
    };
}
