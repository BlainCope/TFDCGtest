...
#include "ControlRig_FRigUnit_SetMultiControlFloat_Entry.h"
...
namespace CG::ControlRig
{
     ...
     */
    struct FRigUnit_SetMultiControlFloat : public ControlRig::FRigUnitMutable
    {
    public:
        BasicTypes::TArray<ControlRig::FRigUnit_SetMultiControlFloat_Entry> Entries;                                                 //  Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
