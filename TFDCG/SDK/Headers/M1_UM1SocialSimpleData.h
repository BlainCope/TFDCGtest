...
{
    /**
     * Class /Script/M1.M1SocialSimpleData
     * Size -> 0x0030 (FullSize[0x0058] - InheritedSize[0x0028])
     */
    class UM1SocialSimpleData : public CoreUObject::UObject
    {
    public:
        BasicTypes::FString                                          AccountName;                                             //  ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
        BasicTypes::FString                                          PlatformAccountName;                                     //  ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/M1.M1SocialSimpleData");
            return ptr;
        }
    };
}
