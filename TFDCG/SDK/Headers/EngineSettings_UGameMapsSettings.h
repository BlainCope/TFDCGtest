...
namespace CG::EngineSettings
{
    ...
    public:
        ...
        CoreUObject::FSoftClassPath                                  GameInstanceClass;                                       //  Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic
        CoreUObject::FSoftObjectPath                                 PrologueMap;                                             //  Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
        ...
        CoreUObject::FSoftClassPath                                  GlobalDefaultGameMode;                                   //  Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate
        CoreUObject::FSoftClassPath                                  GlobalDefaultServerGameMode;                             //  Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate
    ...
    public:
        ...
        EngineSettings::UGameMapsSettings* STATIC_GetGameMapsSettings();
