...
namespace CG::ProceduralMeshComponent
{
     ...
     * Parameters:
     *         ProceduralMeshComponent::UProceduralMeshComponent* InProcMesh                                                 (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     ...
     *         ProceduralMeshComponent::UProceduralMeshComponent* OutOtherHalfProcMesh                                       (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     ...
     *         Engine::UMaterialInterface*                        CapMaterial                                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     *         void                                               ReturnValue
     */
     ...
     * Parameters:
     *         Engine::UStaticMesh*                               InMesh                                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     ...
     *         BasicTypes::TArray<CoreUObject::FVector>           Vertices                                                   (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
     *         BasicTypes::TArray<CoreUObject::FVector2D>         UVs                                                        (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
     *         BasicTypes::TArray<CoreUObject::FVector2D>         UV1s                                                       (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
     *         float                                              GridSpacing                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     *         void                                               ReturnValue
     */
     ...
     *         int32_t                                            LODIndex                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     *         ProceduralMeshComponent::UProceduralMeshComponent* ProcMeshComponent                                          (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     *         bool                                               bCreateCollision                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
     *         void                                               ReturnValue
     */
