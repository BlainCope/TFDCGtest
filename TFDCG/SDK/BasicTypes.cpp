...
#include "Headers/BasicTypes_FNameEntryAllocator.h"
#include "Headers/BasicTypes_FNamePool.h"
...
namespace CG::BasicTypes
{
    ...
    // --------------------------------------------------
    BasicTypes::FNamePool*                                       FName::GNames = nullptr;
     ...
     *         Flags  -> ()
     * Parameters:
     *         BasicTypes::FNameEntry*                            
     *         int32_t                                            key
     */
    BasicTypes::FNameEntry* FNameEntryAllocator::GetById(int32_t key) const
    {
        int block = key >> 16;
     ...
     */
    BasicTypes::FNameEntry* FNamePool::GetNext(uintptr_t& nextFNameAddress, uint32_t* comparisonId) const
    {
     ...
     *         int32_t                                            id
     */
    BasicTypes::FNameEntry* FNamePool::GetById(int32_t id) const
    {
     ...
     *         int32_t                                            id
     */
    BasicTypes::FNameEntry* FNamePool::operator[](int32_t id) const
    {
        return GetById(id);
    }
     ...
     *         Flags  -> ()
     * Parameters:
     *         BasicTypes::FNamePool&                             
     */
    BasicTypes::FNamePool& FName::GetGlobalNames()
    {
        return *GNames;
    }
